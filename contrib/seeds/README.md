...
curl https://mainnet.bitcoin.achow101.com/seeds.txt.gz | gzip -dc >> seeds_main.txt
curl https://testnet.bitcoin.achow101.com/seeds.txt.gz | gzip -dc > seeds_test.txt
