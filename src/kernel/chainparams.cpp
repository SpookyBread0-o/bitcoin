...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.mainnet.bitcoin.achow101.com."); // Ava Chow, only supports x1, x5, x9, x49, x809, x849, xd, x400, x404, x408, x448, xc08, xc48, x40c
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("dnsseed.testnet.bitcoin.achow101.com."); // Ava Chow, only supports x1, x5, x9, x49, x809, x849, xd, x400, x404, x408, x448, xc08, xc48, x40c
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("dnsseed.signet.bitcoin.achow101.com."); // Ava Chow, only supports x1, x5, x9, x49, x809, x849, xd, x400, x404, x408, x448, xc08, xc48, x40c
